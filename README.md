...
AMPB is Firefox-first for normal web browsing. The initial product should control a
hardened Firefox runtime, transport-specific profiles, and AMPB-owned transport setup
before graduating into a deeper Firefox or Tor Browser fork.
